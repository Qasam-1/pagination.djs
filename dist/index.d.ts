 ...
 */
type PButtonStyle = Exclude<ButtonStyle, ButtonStyle.Link>;
/**
...
type PButtonBuilder = Omit<ButtonBuilder, 'data'> & {
...
type PEmbeds = (APIEmbed | JSONEncodable<APIEmbed>)[];
type PAttachments = (Attachment | AttachmentBuilder | AttachmentPayload | BufferResolvable | JSONEncodable<APIAttachment> | Stream)[];
...
declare class Pagination extends PaginationEmbed {
     ...
     * ```
     */
    constructor(messageOrInteraction: Exclude<Interaction, {
        type: InteractionType.ApplicationCommandAutocomplete;
